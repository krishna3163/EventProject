        ...
        <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-gray-50/50">
            ...
            <div className="card max-w-2xl w-full p-8 relative z-10 glass-effect my-12">
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500 font-medium">Join the premium event hub and start competing</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold text-gray-800 border-l-4 border-blue-500 pl-3 mb-4">Personal Details</h3>
                        ...
                        <div className="space-y-4">
                            <h3 className="text-lg font-bold text-gray-800 border-l-4 border-purple-500 pl-3 mb-4">Academic Info</h3>
                            <div className="space-y-2">
                    ...
                    <div className="pt-6 border-t border-gray-100">
                        <h3 className="text-lg font-bold text-gray-800 border-l-4 border-indigo-500 pl-3 mb-6">Security Credentials</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
